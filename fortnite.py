...
async def event_ready():
    print(crayons.green(f'[PartyBot] [{time()}] Bot ist fertig {client.user.display_name}.'))
...
async def event_friend_message(message):
    ...
    if "!skin" in args[0].lower():
        ...
        await message.reply('skin ist jetzt Purple Skull Trooper!')

    elif "!pink" in args[0].lower():
        variants = client.user.party.me.create_variants(
           material=3
        )
        ...
        await message.reply('skin ist jetzt Pink Ghoul Trooper!')
        ...
        await message.reply('Skin ist zu renegade rader geworden')
...
!skull - og skull trooper.
Usage: !purpleskull

!pink - og Ghoul Trooper.
Usage: !pinkghoul
...
Party Commands
!bereit - Sets the readiness of the client to ready.
Usage: !ready
...
Usage: !platform <platform>')
    ...
    elif "!bereit" in args[0].lower():
        await client.user.party.me.set_ready(True)
        await message.reply('Ready!')

    elif ("!unbereit" in args[0].lower()) or ("!sitin" in args[0].lower()):
